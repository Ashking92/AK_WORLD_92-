...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕AK MK▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mAshking92.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
...
\033[1;91m☞ Auther     : AK_WORLD_92
\033[1;92m☞ WhatsApp   : 7385066631
\033[1;95m☞ Instagram    : https://instagram.com/ash_the_hackerr?utm_medium=copy_link
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update ASH_KING Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' AK_WORLD WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/AK_WORLD_92)
	    os.system('cd $HOME && git clone https://github.com/Ashking92/Akworld)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To AK_WORLD')
	    psb('Congratulations AK_WORLD Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('follow me on Instagram Ash_the_hackerr ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/AK_WORLD && python2 AK.py')
	elif bm =='3':
